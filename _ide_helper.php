 ...
 * Generated for Laravel 5.7.3 on 2020-04-29 16:53:45.
 *
...
namespace  {
    ...
    class Auth extends \Illuminate\Support\Facades\Auth {
         ...
         * @param string $name
         * @param array $config
         * @return \App\ModelServices\Auth\MessengerGuard
         * @static
         */
        ...
        {
            /** @var \App\ModelServices\Auth\MessengerGuard $instance */
        ...
        public static function macro($name, $macro)
        {
            \App\ModelServices\Auth\MessengerGuard::macro($name, $macro);
        }
        ...
        public static function mixin($mixin)
        {
            \App\ModelServices\Auth\MessengerGuard::mixin($mixin);
        }
        ...
        public static function hasMacro($name)
        {
            return \App\ModelServices\Auth\MessengerGuard::hasMacro($name);
        }
